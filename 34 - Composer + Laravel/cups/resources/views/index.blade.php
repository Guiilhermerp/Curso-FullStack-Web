    ...
    <div class="site-block-wrap">
      <div class="owl-carousel with-dots">
        <div class="site-blocks-cover overlay overlay-2"
          style="background-image: url('https://cdn.awsli.com.br/1000x1000/362/362061/produto/291198999893923d5b.jpg');"
          ...
          <div class="container">
            <div class="row align-items-center justify-content-center">
              <div class="col-md-6 mt-lg-5 text-center">
                <h1 class="text-shadow">Canecas Personalizadas Como você nunca viu</h1>
                <p class="mb-5 text-shadow">Mande sua imagem que nós atendemos seu pedido!</p>
                <p><a href="#" target="_blank" class="btn btn-primary px-5 py-3">Eu quero!</a></p>
        ...
        <div class="site-blocks-cover overlay overlay-2"
          style="background-image: url('https://images.tcdn.com.br/img/img_prod/571052/caneca_a_evolucao_nerd_e_geek_286_1_20181127124001.jpeg');"
          data-aos="fade" id="home-section">
          ...
          <div class="container">
            <div class="row align-items-center justify-content-center">
              <div class="col-md-6 mt-lg-5 text-center">
                <h1 class="text-shadow">Find Your Perfect Canecão</h1>
                <p class="mb-5 text-shadow">Canecas criativas do jeito que você gosta</p>
                <p><a href="#" target="_blank" class="btn btn-primary px-5 py-3">Ver todas</a></p>
      ...
      <div class="container">
        <div class="row large-gutters">
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5 ">
            <div class="ftco-media-1">
              <div class="ftco-media-1-inner">
                <a href="property-single.html" class="d-inline-block mb-4"><img src="images/property_2.jpg" alt="Image"
                    class="img-fluid"></a>
                <div class="ftco-media-details">
                  <h3>HD17 19 Utica Ave.</h3>
                  <p>New York - USA</p>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5 ">
            <div class="ftco-media-1">
              <div class="ftco-media-1-inner">
                <a href="property-single.html" class="d-inline-block mb-4"><img src="images/property_3.jpg" alt="Image"
                    class="img-fluid"></a>
                <div class="ftco-media-details">
                  <h3>HD17 19 Utica Ave.</h3>
                  <p>New York - USA</p>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5 ">
            <div class="ftco-media-1">
              <div class="ftco-media-1-inner">
                <a href="property-single.html" class="d-inline-block mb-4"><img src="images/property_1.jpg" alt="Image"
                    class="img-fluid"></a>
                <div class="ftco-media-details">
                  <h3>HD17 19 Utica Ave.</h3>
                  <p>New York - USA</p>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              ...
              <h2 class="font-size-regular"><a href="single.html" class="text-dark">Popular Real Estate Properties for
                  2019</a></h2>
